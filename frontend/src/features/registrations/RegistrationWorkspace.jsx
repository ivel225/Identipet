...
export default function RegistrationWorkspace({ section = "all", onSaved }) {
  ...
  return (
    <div className="grid gap-5">
      {showOwners ? <OwnerForm onSaved={onSaved} /> : null}
      {showPets ? <PetForm onSaved={onSaved} /> : null}
      {showTags ? <NfcTagAssignmentForm onSaved={onSaved} /> : null}
    </div>
  );
}
